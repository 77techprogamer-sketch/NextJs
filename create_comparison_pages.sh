#!/bin/bash
cd /home/kali/insurance-support-next
mkdir -p src/app/lic-vs-private-life src/app/lic-vs-hdfc-life src/app/lic-vs-sbi-life src/app/lic-vs-icici-pru src/app/comparisons

# Page 1: LIC vs Private
cat > src/app/lic-vs-private-life/page.tsx << 'EOF1'
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="container mx-auto px-4 max-w-5xl mt-16 prose prose-slate max-w-none">
        ...
        <p>Life Insurance Corporation of India (LIC) has been the backbone of life insurance in India for over six decades. Established in 1956 through an Act of Parliament, LIC has grown to become not just India largest but the world largest life insurance company by number of policies sold.</p>
        <h3>Sovereign Guarantee: The Ultimate Security</h3>
        <p>The most significant advantage LIC holds over all private insurers is the sovereign guarantee from the Government of India. Under Section 37 of the Life Insurance Corporation Act, 1956, all policies issued by LIC are guaranteed by the Central Government. This means that regardless of market conditions, your sum assured plus declared bonuses will be paid in full.</p>
        ...
        <p>LIC offers policy loans at competitive rates (currently 10% simple interest) after 3 years of premium payment. The loan amount can be up to 90% of the surrender value, providing liquidity to policyholders during financial emergencies without requiring them to surrender their life cover.</p>
        ...
        <h3>Conclusion</h3>
        <p>When comparing LIC with private life insurance companies, the choice comes down to what you value most. If trust, stability, sovereign guarantee, and nationwide accessibility are your priorities, LIC remains unmatched with 98.5% claim settlement and 68+ years of consistent performance.</p>
      </div>
    </div>
  );
}
