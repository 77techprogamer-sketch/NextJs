...
const PROCESS_STEPS = [
    ...
    { step: '5', title: 'Claim Approved & Paid', desc: 'We work on your claim until it is approved and the money is credited to your account.' },
];
                ...
                <div className="container px-4 mx-auto relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                            ...
                            <br />
                            <span className="text-accent">High Success Rate.</span>
                        </h1>
            ...
            <section className="py-16 bg-slate-50">
                <div className="container px-4 mx-auto max-w-2xl">
                    <div className="text-center mb-8">
                        <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">Submit Your Rejection Letter for Free Review</h2>
                        <p className="text-slate-600 text-lg">
                            Share your rejection letter and policy details. Our experts will analyze your case and tell you if we can help — within 24 hours.
                        </p>
                    </div>
                    <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm">
                        <ShortLeadForm source="claim_recovery_page" service="claim_recovery" />
                    </div>
                </div>
            </section>
