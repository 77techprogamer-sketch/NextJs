...
export const metadata: Metadata = {
    ...
    description: 'Explore our comprehensive insurance services â€” Life, Health, Motor, Term, SME, Travel, Pension, ULIP, Wedding & Cyber insurance. Expert support for claim recovery, policy revival, and financial planning with 25+ years of experience.',
    keywords: [
        ...
        <div className="bg-white min-h-screen">
                ...
                <div className="container px-4 mx-auto">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <p className="text-slate-600 text-lg mb-10 max-w-3xl leading-relaxed">
                            We don&apos;t just help you buy insurance â€” we stay with you throughout the entire policy lifecycle. Here&apos;s what sets our service apart from online portals and traditional agents.
                        </p>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { icon: FileText, title: 'Doorstep Service', desc: 'We visit your home or office for documentation, form filling, and policy delivery â€” no branch visits ever needed.' },
                                ...
                                { icon: TrendingUp, title: 'Claim Recovery Experts', desc: 'Specialized in reversing rejected claims through GRO, IRDAI, and Insurance Ombudsman channels, recovering â‚¹50Cr+ for families.' },
            ...
            <section className="py-16 bg-white">
                <div className="container px-4 mx-auto max-w-4xl">
                    ...
                    <p className="text-lg text-slate-600 mb-10 leading-relaxed">From initial conversation to lifetime support â€” here&apos;s what every engagement looks like.</p>
                    <div className="flex flex-col md:flex-row gap-6">
                        {[
                            { step: '1', title: 'Free Consultation', desc: 'Tell us about your insurance needs, existing policies, or claim issues. We listen, assess, and provide a clear recommendation â€” completely free, no obligation.' },
                            ...
                            { step: '3', title: 'Lifetime Support', desc: 'Once onboarded, you get lifetime advisory support â€” renewals, additional coverage, claim filing, and annual policy health check-ups at no extra cost.' },
                        ].map((item, i) => (
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            <div className="flex-1 space-y-4">
                                ...
                                <p className="text-slate-400 text-lg leading-relaxed">
                                    Not sure which insurance product is right for you? Whether you need coverage for a growing family, a business, or want help recovering a stuck claim â€” our expert advisors will build a personalized insurance portfolio tailored to your exact needs and budget.
                                </p>
                            </div>
