...
export const metadata: Metadata = {
    ...
    description: 'Expert LIC policy support for Jalahalli, Bahubali Nagar, Yeshwanthpur & North Bangalore. Get help with lapsed policies, death claims, maturity settlements & revival. IRDAI-certified advisor with 25+ years. Rated 4.2★ on Justdial.',
    keywords: [
    ...
    openGraph: {
        title: 'LIC Policy Support — Jalahalli & North Bangalore Expert',
    ...
    '@graph': [
        {
            ...
            name: 'Insurance Support — LIC Policy Expert',
            description: 'Expert LIC policy support, claim recovery, and revival services for North Bangalore (Jalahalli, Bahubali Nagar, Yeshwanthpur). IRDAI-certified advisor, 25+ years experience, 4.2★ rated on Justdial.',
            url: 'https://insurancesupport.online/services/lic-policy-support',
...
const licServices = [
    {
        ...
        desc: 'Revive your lapsed LIC policy under special revival schemes. I calculate exact costs and complete all paperwork — fast-tracked through North Bangalore LIC branches.'
    },
    {
        icon: <FileSearch className="w-6 h-6 text-blue-600" />,
        title: 'Death Claim Settlement',
        desc: 'End-to-end support for death claim filing — from collecting documents to personally tracking your case through the LIC branch until settlement.'
    },
    {
    ...
    },
    {
        ...
        desc: 'Updating nominees or correcting errors in your LIC policy — name, date of birth, address — processed quickly with minimal hassle.'
    },
    {
                    ...
                    <div className="flex flex-col lg:flex-row gap-12 items-start">
                        <div className="flex-1">
                            ...
                            <p className="text-xl text-slate-300 leading-relaxed mb-8">
                                ...
                                IRDAI-certified LIC expert with 25+ years of experience — serving Jalahalli,
                        ...
                        <div className="w-full lg:w-[360px] bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6">
                            ...
                            <p className="text-slate-400 text-sm mb-5">Tell us your issue — we'll respond within 2 hours.</p>
            ...
            <div className="bg-orange-50 border-y border-orange-100 py-4 px-4">
                <div className="container mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-center gap-3 text-center sm:text-left">
                    ...
                    <p className="text-slate-700 font-medium text-sm">
                        <strong className="text-orange-700">Rated 4.2★ on Justdial</strong> — independently reviewed by local clients in Bangalore as a top-rated LIC advisor.
                    </p>
                    <span className="hidden sm:block text-slate-300">|</span>
                    <p className="text-slate-500 text-sm">25+ years · 15,000+ clients served · IRDAI licensed</p>
                </div>
            </div>
                ...
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
                            <h3 className="font-bold text-green-800 mb-4 text-lg">Hari Kotian — Your Local LIC Expert</h3>
                            <ul className="space-y-3">
                                {[
                                    ...
                                    '4.2★ rated on Justdial — independently verified'
                                ].map((item, i) => (
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            },
                            {
                                ...
                                a: 'Online aggregators sell policies but are absent when claims get rejected. As your local IRDAI-certified advisor with 25+ years of experience, I personally represent you at the LIC branch, handle disputes, and escalate to the Insurance Ombudsman if needed — a service no online portal provides.'
                            }
                        ].map((faq, i) => (
