...
export const metadata: Metadata = {
    title: {
        absolute: 'Loan Against Insurance Policy India | LIC Policy Loan, Interest Rates & Process â€” Insurance Support'
    },
    ...
    openGraph: {
        title: 'Loan Against Insurance Policy | Expert Advisory â€” Insurance Support',
...
const faqSchema = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'LIC policy loan interest rates range from 9% to 10% per annum (simple interest), which is significantly lower than personal loans (12-24%) or credit card cash advances (36%+). The rate depends on when the policy was purchased â€” older policies typically have lower loan rates. Interest is charged half-yearly.'
            }
        },
        {
            '@type': 'Question',
                ...
                <div className="container px-4 mx-auto relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed mb-10 max-w-3xl">
                            Need immediate funds without breaking your long-term insurance investment? A loan against your LIC or life insurance policy offers the lowest interest rates â€” often 50-70% cheaper than personal loans. Our advisors help you unlock the full financial potential of your existing policies.
                        </p>
            ...
            <section className="py-16 bg-slate-50 border-b border-slate-100">
                <div className="container px-4 mx-auto max-w-5xl">
                    ...
                    <div className="prose prose-slate prose-lg max-w-none">
                        ...
                        <p>
                            This is particularly valuable for <strong>LIC policyholders</strong> in India, where policies like Jeevan Anand, Jeevan Lakshya, and other endowment plans build substantial surrender values over 5-10 years. Rather than taking a high-interest personal loan during a financial emergency, you can tap into this existing asset at 9-10% interest â€” roughly half the cost of a bank personal loan.
                        </p>
                        <p>
                    ...
                    <div className="overflow-x-auto border rounded-xl">
                        <table className="w-full text-left">
                            ...
                            <tbody className="divide-y text-sm">
                                <tr><td className="p-4 border-r font-medium">Interest Rate</td><td className="p-4 text-green-700 font-medium">9â€“10% p.a.</td><td className="p-4 text-slate-600">12â€“24% p.a.</td><td className="p-4 text-slate-600">10â€“16% p.a.</td></tr>
                                ...
                                <tr><td className="p-4 border-r font-medium">Approval Time</td><td className="p-4 text-green-700 font-medium">5â€“7 working days</td><td className="p-4 text-slate-600">2â€“7 days</td><td className="p-4 text-slate-600">Same day</td></tr>
                                ...
                                <tr><td className="p-4 border-r font-medium">Prepayment Penalty</td><td className="p-4 text-green-700 font-medium">Zero</td><td className="p-4 text-slate-600">2â€“5% typically</td><td className="p-4 text-slate-600">Varies</td></tr>
                                <tr><td className="p-4 border-r font-medium">Risk Cover Continues</td><td className="p-4 text-green-700 font-medium">Yes â€” policy stays active</td><td className="p-4 text-slate-600">N/A</td><td className="p-4 text-slate-600">N/A</td></tr>
                ...
                <div className="container px-4 mx-auto max-w-5xl">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        ...
                        <div className="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm">
                            ...
                            <ul className="space-y-3 text-sm text-slate-600">
                                <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">âœ—</span>Term Insurance Plans (no surrender value)</li>
                                <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">âœ—</span>ULIP Plans during lock-in period (first 5 years)</li>
                                <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">âœ—</span>Health Insurance Policies</li>
                                <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">âœ—</span>Fully lapsed policies with no paid-up value</li>
                                <li className="flex items-start gap-2"><span className="text-red-400 shrink-0 mt-0.5">âœ—</span>Micro Insurance and group term plans</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-16 bg-white">
                <div className="container px-4 mx-auto max-w-4xl">
                    ...
                    <div className="space-y-6">
                        {[
                            { step: '1', title: 'Free Eligibility Check', desc: 'Share your policy number with us. We verify the current surrender value, check if your policy qualifies, and calculate the maximum loan amount you can get â€” all within 24 hours.' },
                            { step: '2', title: 'Document Collection', desc: 'We collect your original policy bond, a signed loan application form (provided by us), ID proof, and a cancelled cheque for NEFT disbursement â€” right at your doorstep.' },
            ...
            <section className="py-16 bg-slate-50 border-t border-slate-100">
                <div className="container px-4 mx-auto">
                    ...
                    <p className="text-slate-600 text-center mb-10 max-w-2xl mx-auto leading-relaxed">
                        Beyond policy loans, we help you find the best loan products tailored for the Indian market â€” home loans, personal loans, education loans, and more.
                    </p>
                    <LoansPageClient />
                </div>
            </section>
                ...
                <div className="container px-4 mx-auto max-w-4xl">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            { q: 'What is the interest rate for a loan against LIC policy?', a: 'LIC policy loan interest rates range from 9% to 10% per annum (simple interest). The rate depends on when the policy was purchased â€” older policies typically have lower rates. Interest is charged half-yearly.' },
                            ...
                            { q: 'How long does it take to get a loan against insurance?', a: 'With our doorstep processing, a policy loan can be sanctioned within 5-7 working days. We handle the entire process â€” document collection, branch submission, and follow-up â€” so you don\'t have to visit any office.' },
                    ...
                    <div className="bg-slate-900 rounded-3xl p-8 md:p-16 text-white relative overflow-hidden max-w-5xl mx-auto">
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            <div className="flex-1">
                                <h2 className="text-3xl font-bold mb-4">Check Your Policy Loan Eligibility â€” Free</h2>
