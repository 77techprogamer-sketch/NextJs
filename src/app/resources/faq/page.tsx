...
export const metadata: Metadata = {
    title: 'Frequently Asked Questions â€” Insurance Claims, Policies & Recovery | Insurance Support',
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed max-w-3xl">
                            Detailed answers and deep dives into common insurance queries â€” written by advisors with 25+ years of hands-on claims experience. Not generic copy from a portal, but real-world knowledge from thousands of cases.
                        </p>
                    </div>
                </div>
            </section>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="health-1">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <Link href="/resources/guides/claim-rejection-appeal" className="text-primary font-medium hover:underline block mt-2">Read our complete Claim Recovery guide â†’</Link>
                                    </AccordionContent>
                                </AccordionItem>
                                ...
                                <AccordionItem value="health-3">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        <p><strong>Cashless:</strong> Available at &quot;network hospitals&quot; empanelled with your insurer. The hospital bill is settled directly by the insurance company â€” you pay nothing except non-medical consumables. Requires pre-authorization from the TPA desk before or during admission.</p>
                                        ...
                                        <Link href="/resources/guides/cashless-hospitalization-guide" className="text-primary font-medium hover:underline block mt-2">Read our Cashless Hospitalization Guide â†’</Link>
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </section>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="lic-1">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <p>We specialize in revival cases that branches initially refuse â€” including policies lapsed for 10-15 years. A thorough understanding of LIC&apos;s internal circulars and revival campaign timelines allows us to recover value that most agents consider lost.</p>
                                        <Link href="/resources/guides/lapsed-policy-revival" className="text-primary font-medium hover:underline block mt-2">Read our complete Policy Revival guide â†’</Link>
                                    </AccordionContent>
                                </AccordionItem>
                                ...
                                <AccordionItem value="lic-2">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <p>We handle the entire process including the legal drafting of the indemnity bond, newspaper advertisement coordination, and branch submissions â€” saving you multiple trips and legal fees.</p>
                                        <Link href="/resources/guides/lic-revival-maturity-masterclass" className="text-primary font-medium hover:underline block mt-2">See our Lost Policy Support steps â†’</Link>
                                    </AccordionContent>
                                </AccordionItem>
                                ...
                                <AccordionItem value="lic-3">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <p>If all documents are submitted on time, the maturity amount â€” including the Sum Assured plus accumulated bonuses â€” is credited directly to your linked bank account within 7-15 working days of the maturity date. We recommend starting the process 30 days in advance to avoid processing delays.</p>
                                        <Link href="/resources/guides/lic-revival-maturity-masterclass" className="text-primary font-medium hover:underline block mt-2">Read the full Maturity Claim Guide â†’</Link>
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </section>
                                ...
                                <AccordionItem value="motor-2">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <ol className="list-decimal pl-6 space-y-2">
                                            ...
                                            <li><strong>Do not move the vehicle</strong> for major damage â€” wait for the surveyor or get a spot survey from the insurer&apos;s mobile app.</li>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                ...
                                <AccordionItem value="gen-2">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <ul className="list-disc pl-6 space-y-2">
                                            ...
                                            <li><strong>Binding on insurer:</strong> The Ombudsman&apos;s award is binding on the insurance company (but not on the policyholder â€” you retain the right to pursue civil remedies).</li>
                                            <li><strong>Jurisdiction:</strong> Claims up to â‚¹30 lakhs are covered. For higher amounts, consumer courts are the appropriate forum.</li>
                                        </ul>
                                ...
                                <AccordionItem value="gen-3">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <ul className="list-disc pl-6 space-y-2">
                                            <li><strong>New policy purchase:</strong> No additional charge to you â€” advisors are compensated by insurer commissions as per IRDAI norms.</li>
                                        ...
                                        <p>We believe in transparency â€” there are never any hidden charges, and we will always explain our fee structure upfront before commencing any engagement.</p>
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </section>
                            ...
                            <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                                ...
                                <ul className="space-y-2">
                                    {[
                                        ...
                                        { label: 'LIC Maturity Claim Process', href: '/resources/guides/lic-revival-maturity-masterclass' },
