                            ...
                            <Accordion type="single" collapsible className="w-full">
                                ...
                                <AccordionItem value="lic-2">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <Link href="/resources/guides/lic-revival-maturity-masterclass" className="text-primary font-medium hover:underline block mt-2">See our Lost Policy Support steps →</Link>
                                    </AccordionContent>
                                </AccordionItem>
                                ...
                                <AccordionItem value="lic-3">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed space-y-4">
                                        ...
                                        <Link href="/resources/guides/lic-revival-maturity-masterclass" className="text-primary font-medium hover:underline block mt-2">Read the full Maturity Claim Guide →</Link>
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </section>
