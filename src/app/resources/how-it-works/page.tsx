...
export const metadata: Metadata = {
    title: 'How It Works â€” Our 4-Phase Claim Recovery & Policy Support Process | Insurance Support',
...
const howToSchema = {
    ...
    '@type': 'HowTo',
    name: 'How Insurance Support Works â€” 4-Phase Process',
    ...
    step: [
        ...
        },
        {
            ...
            text: 'We handle all the heavy lifting â€” gathering documents, communicating with hospitals, TPAs, and insurance companies, and drafting medical representations for appeals.'
        },
        {
            '@type': 'HowToStep',
                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                            {[
                                ...
                                { value: 'Crores+', label: 'Recovered for Families' },
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    Every engagement starts with a thorough, no-obligation assessment. We sit down with you â€” either at your doorstep, office, or via a secure video call â€” to understand your specific situation. Whether you are exploring a new policy, confused by a rejection letter, or wondering if your old LIC investment can be salvaged, this phase gives us the complete picture.
                                </p>
                                ...
                                <div className="flex items-center gap-2 text-sm text-slate-500">
                                    ...
                                    <span>Typical duration: 30â€“60 minutes | Cost: â‚¹0 (Always Free)</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    This is where our 25 years of experience shows. We take over the entire operational burden â€” gathering the correct documents, communicating directly with hospitals, TPAs (Third Party Administrators), and insurance companies on your behalf. For claim appeals, we draft legally sound medical representations that address the exact clauses cited in the rejection.
                                </p>
                                <div className="grid sm:grid-cols-2 gap-4 mb-6">
                                    {[
                                        'Document collection from your home â€” no branch visits for you',
                                ...
                                <div className="flex items-center gap-2 text-sm text-slate-500">
                                    <Clock className="h-4 w-4" />
                                    <span>Typical duration: 3â€“7 working days depending on complexity</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 leading-relaxed mb-6">
                                    If a claim is delayed beyond the stipulated timeframe or outright denied, we activate our three-tier escalation protocol. Unlike a call center that reads a script, our advisors understand the internal decision-making hierarchy of each major insurer â€” from the Claims Manager to the Zonal Head â€” and know exactly which level of escalation will produce results fastest.
                                </p>
            ...
            <section className="py-16 bg-slate-50">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <p className="text-slate-600 mb-10 max-w-2xl">
                        To make the initial consultation as productive as possible, keep these handy. Don&apos;t worry if you&apos;re missing something â€” we help locate lost documents too.
                    </p>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { title: 'Policy Bond or Number', desc: 'The original policy document or at least the 9â€“10 digit policy number for any LIC or private insurer policy.' },
                            ...
                            { title: 'Premium Payment Proof', desc: 'Bank statements or receipts showing premium payment history â€” helpful for lapsed policy revival assessments.' },
                    ...
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="faq-1">
                            ...
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                Yes, always. The first consultation â€” whether in person or via video call â€” is completely free with no obligation. We assess your case, explain your options, and provide a preliminary feasibility report. You decide whether to proceed.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="faq-2">
                            ...
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                It depends on the case type. Simple maturity claims or policy revivals typically resolve in 10â€“15 working days. Rejected claim appeals through the internal grievance channel take 15â€“30 days. Ombudsman escalations can take 4â€“6 months. We keep you informed at every stage with regular status updates.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="faq-5">
                            <AccordionTrigger className="text-left font-semibold">What if my case seems hopeless â€” can you still help?</AccordionTrigger>
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                Many of our most successful recoveries were cases that clients believed were lost causes. A claim rejected 2 years ago, a policy lapsed for 10+ years, or a death claim denied for alleged non-disclosure â€” we have reversed all of these through proper documentation, regulatory escalation, and deep knowledge of IRDAI guidelines. Let us assess it before you give up.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </div>
            ...
            <section className="py-16 bg-primary/5 border-t border-primary/10">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    ...
                    <p className="text-lg text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed">
                        Your first step is a free consultation. No paperwork needed upfront â€” just tell us your situation and we&apos;ll guide you from there.
                    </p>
