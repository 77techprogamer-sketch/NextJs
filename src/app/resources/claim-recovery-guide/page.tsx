...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://insurancesupport.online/resources/claim-recovery-guide'
    }
};
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <GuideArticleJsonLd 
                ...
                url="https://insurancesupport.online/resources/claim-recovery-guide"
            />
...
// Internal Data/Helper Components for SEO
const Search = ({ className }: { className?: string }) => <Globe className={className} />;
