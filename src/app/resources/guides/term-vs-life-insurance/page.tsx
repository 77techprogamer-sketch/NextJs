...
export const metadata: Metadata = {
    title: 'Term Insurance vs Life Insurance â€” Which Should You Choose in 2026?',
                        ...
                        <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 mb-10 flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-blue-800 text-sm italic">
                                    &quot;Term Insurance is like a safety netâ€”cheap and massive. Endowment/Life plans are like a safety net with a money-back featureâ€”much more expensive but ensures you get something back if you survive. Both have their place.&quot;
                                </p>
                            </div>
                        </div>
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y">
                                        <tr>
                                            ...
                                            <td className="p-4 text-green-600 font-medium">Ultra Low (â‚¹1000/mo for 1Cr)</td>
                                            <td className="p-4 text-red-500">High (â‚¹10,000/mo for 10L)</td>
                                        </tr>
                                        <tr>
