                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="space-y-8">
                                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                                    ...
                                    <p className="text-slate-600 text-sm">Affix a <strong>₹1 Revenue Stamp</strong> on the designated spot at the bottom of the form. You must sign <em>across</em> the stamp. Without the stamp, the form is legally void.</p>
                                </div>
                                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                            ...
                            <ul className="list-disc pl-6 space-y-4 text-slate-700 font-medium">
                                ...
                                <li>Original LIC Form 3825 (Signed across ₹1 stamp)</li>
                    ...
                    __html: JSON.stringify({
                        ...
                        "mainEntity": [
                            ...
                            },
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Yes, affixing a ₹1 revenue stamp and signing across it is mandatory. It acts as a legal receipt of payment. Without it, the form will be rejected."
                                }
                            }
                        ]
                    })
