                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <p className="mb-10">
                                Portals are designed to show you the lowest premium in seconds. However, they often hide the &quot;fine print&quot;—waiting periods, restrictive clauses, and non-disclosure traps—that lead to claim rejections later on.
                            </p>
                            ...
                            <div className="bg-blue-600 rounded-[40px] p-10 text-white shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-blue-100 text-lg mb-8 max-w-2xl">
                                        Speak directly to an IRDAI-certified expert. No scripts, no call centers — just real solutions for your peace of mind.
                                    </p>
