                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-12 not-prose">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link href="/locations/karnataka/bangalore/lic-agent" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                    ...
                                    <Link href="/locations/telangana/hyderabad/life-insurance" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                        Hyderabad Support
                                    </Link>
