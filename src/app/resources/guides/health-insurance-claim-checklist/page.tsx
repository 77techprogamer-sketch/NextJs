...
export const metadata: Metadata = {
    title: 'Health Insurance Claim Checklist â€” Documents & Process (2026)',
    ...
    return (
        <div className="bg-white min-h-screen">
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 my-8">
                                <p className="text-blue-900 text-sm">
                                    Based in Karnataka? Our <Link href="/locations/karnataka/bangalore/health-insurance" className="font-bold border-b-2 border-blue-200 hover:border-blue-500 transition-colors">health insurance advisor in Bangalore</Link> provides comprehensive assistance handling and submitting these documents.
                                </p>
                            </div>
                        </div>
            ...
            <GuideArticleJsonLd 
                ...
                url={`https://insurancesupport.online/resources/guides/health-insurance-claim-checklist`}
            />
        </div>
    );
}
