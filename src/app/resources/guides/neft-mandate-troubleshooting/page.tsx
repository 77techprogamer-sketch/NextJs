                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                                    ...
                                    <p className="text-slate-600 text-sm">If your name differs between the policy and the bank, you must submit an Affidavit on â‚¹100 stamp paper stating that both names belong to the same person. Alternatively, officially change your name in the bank using your Aadhar to match the policy.</p>
                                </div>
                                <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
