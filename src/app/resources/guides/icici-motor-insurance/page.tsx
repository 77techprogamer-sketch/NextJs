    ...
    return (
        <div className="bg-white min-h-screen">
                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="space-y-12 my-16">
                                ...
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 leading-relaxed text-sm font-medium">Critical for flood-prone cities like Mumbai or Bangalore. Covers engine damage due to water ingression or oil leakageâ€”which is otherwise considered "consequential damage" and rejected.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 leading-relaxed text-sm font-medium">24/7 support for towing, flat tires, battery jumpstarts, and even fuel delivery. ICICI Lombardâ€™s RSA is praised for its response time in Tier-1 cities.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-900 text-white p-12 rounded-[4rem] my-12 relative overflow-hidden group shadow-2xl transition-all hover:shadow-primary/10">
                                ...
                                <p className="text-slate-400 mb-8 font-medium">For minor repairs (scratches/dents costing under â‚¹25,000), ICICI Lombard uses a 2026 AI model called **InstaCompute**.</p>
                                <ul className="space-y-4 text-sm font-bold">
                                    <li className="flex gap-3"><CheckCircle2 className="h-4 w-4 text-primary" /> Take a 360Â° video of the car via the app.</li>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                <AccordionItem value="faq-1">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed pb-8 text-lg font-medium">
                                        Even with Zero-Dep, you have to pay for oil, coolants, nuts, and bolts. Consumables cover ensures ICICI Lombard pays for these recurring items too, making your claim effectively â‚¹0 out-of-pocket.
                                    </AccordionContent>
                                </AccordionItem>
                        ...
                        <div className="bg-slate-50 border-2 border-slate-100 p-12 rounded-[4rem] my-24 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link href="/locations/maharashtra/mumbai/motor-insurance" className="px-8 py-4 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Mumbai Network List</Link>
                            </div>
                        </div>
            ...
            <GuideArticleJsonLd 
                ...
                url={`https://insurancesupport.online/resources/guides/icici-motor-insurance`}
            />
        </div>
    );
}
