...
export const metadata: Metadata = {
    title: 'Cashless Hospitalization Process â€” Step-by-Step Guide (2026)',
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mt-8">
                                <div className="p-6 border rounded-2xl bg-slate-50">
                                    ...
                                    <p className="text-sm">Start the process <strong>48â€“72 hours before</strong> admission. Visit the hospital TPA desk with your policy card for pre-approval.</p>
                                </div>
                                <div className="p-6 border rounded-2xl bg-slate-50">
                            ...
                            <div className="space-y-8 mt-8">
                                ...
                                <div className="flex gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p>The insurer issues an initial &quot;Credit Letter&quot; (authorization) within 2â€“6 hours. This covers most surgical costs.</p>
                                    </div>
                                </div>
                                <div className="flex gap-6">
                            ...
                            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-12 not-prose">
                                ...
                                <div className="flex flex-wrap gap-4">
                                    <Link href="/locations/karnataka/bangalore/health-insurance" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                        health insurance advisor in Bangalore
                                    </Link>
                                    <Link href="/locations/tamil-nadu/chennai/life-insurance" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                        Chennai Advisor
                                    </Link>
                                    <Link href="/locations/maharashtra/pune/life-insurance" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                        Pune Support
                                    </Link>
                                    <Link href="/locations/maharashtra/mumbai/life-insurance" className="text-sm border-b-2 border-blue-200 hover:border-blue-500 font-bold text-blue-800 transition-colors">
                                        Mumbai Expert
                                    </Link>
                                </div>
