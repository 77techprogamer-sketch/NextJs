                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                            ...
                            <div className="p-10 bg-slate-900 text-white rounded-[3rem] shadow-2xl relative overflow-hidden group">
                                ...
                                <p className="text-xs text-slate-400 font-medium">5% tax on 'Income Component' if aggregate maturity exceeds â‚¹1 Lakh in a year.</p>
                            </div>
                        </div>
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <p className="text-slate-600 mb-10 leading-relaxed">
                                ...
                                <br/>
                                <strong>Step 2:</strong> Execute an <strong>Indemnity Bond (Form 3762)</strong> on non-judicial stamp paper. The value of the stamp paper varies by state (usually â‚¹100 to â‚¹500).
                                <br/>
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="relative pl-20">
                                    ...
                                    <p className="text-slate-500 text-sm leading-relaxed">You can now submit maturity documents at <strong>any LIC Branch</strong> (not just the servicing one) thanks to "All India Portability." Alternatively, use the LIC Customer Portal if your sum assured is under â‚¹10 Lakhs.</p>
                                </div>
                            </div>
                        ...
                        <div className="bg-slate-50 border-2 border-slate-100 p-12 rounded-[4rem] my-24 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <Link href="/locations/karnataka/bangalore/life-insurance" className="px-8 py-3 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Bangalore (Jalahalli/HSR)</Link>
                                <Link href="/locations/maharashtra/mumbai/life-insurance" className="px-8 py-3 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Mumbai (Fort/Borivali)</Link>
                                <Link href="/locations/telangana/hyderabad/life-insurance" className="px-8 py-3 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Hyderabad Support</Link>
                            </div>
                        </div>
                    ...
                    __html: JSON.stringify({
                        ...
                        "mainEntity": [
                            ...
                            },
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "If the bond is lost, you must submit an Indemnity Bond on non-judicial stamp paper (Form 3762) and a Questionnaire regarding the loss. In 2026, an FIR is usually not required for sum assured under â‚¹5 Lakhs."
                                }
                            },
                            {
                                "@type": "Question",
                            ...
                            },
                            {
                                ...
                                "acceptedAnswer": {
                                    "@type": "Answer",
                                    "text": "Yes, for policies with sum assured up to â‚¹10 Lakhs, LIC allows digital submission of scanned documents via the LIC Customer Portal. For higher amounts, physical submission at a branch is required."
                                }
                            }
                        ]
                    })
