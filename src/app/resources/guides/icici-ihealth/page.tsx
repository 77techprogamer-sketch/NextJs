                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
                            ...
                            <div className="p-8 bg-slate-900 text-white rounded-[2.5rem] shadow-xl">
                                ...
                                <h4 className="text-xl font-black mb-1">4.8 â˜…</h4>
                            ...
                            <div className="p-8 bg-slate-900 text-white rounded-[2.5rem] shadow-xl">
                                ...
                                <h4 className="text-xl font-black mb-1">âˆž</h4>
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="space-y-12 my-16">
                                ...
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 leading-relaxed text-sm font-medium">If your Sum Insured (SI) is exhausted during a policy year, it automatically resets to 100% for the next hospitalizationâ€”even for the SAME illness, which is a significant upgrade from older 2024 terms.</p>
                                    </div>
                                </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-16">
                                <div className="p-10 bg-white border-2 border-slate-100 rounded-[4rem] shadow-xl hover:border-primary/20 transition-all">
                                    ...
                                    <ul className="space-y-4 text-sm font-bold text-slate-600 mb-12">
                                        <li className="flex gap-2"><CheckCircle2 className="h-4 w-4 text-green-500" /> {"â‚¹5L to â‚¹50L Sum Insured"}</li>
                                ...
                                <div className="p-10 bg-slate-900 text-white border-2 border-primary/20 rounded-[4rem] shadow-2xl relative overflow-hidden">
                                    ...
                                    <ul className="space-y-4 text-sm font-bold text-slate-300 mb-12">
                                        <li className="flex gap-2"><Shield className="h-4 w-4 text-primary" /> â‚¹50L to â‚¹1Cr+ Sum Insured</li>
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                ...
                                <AccordionItem value="faq-3">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed pb-8 text-lg font-medium">
                                        Most iHealth Shield and Elite plans (SA â‚¹10L+) have **No Room Rent Capping**. This means you can choose an Executive Room or Suite if required, without having to pay a proportional deduction on other medical bills.
                                    </AccordionContent>
                                </AccordionItem>
                            </Accordion>
                        </div>
                        ...
                        <div className="bg-slate-50 border-2 border-slate-100 p-12 rounded-[4rem] my-24 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link href="/locations/karnataka/bangalore/health-insurance" className="px-8 py-4 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Local Search Assistance</Link>
                            </div>
                        </div>
