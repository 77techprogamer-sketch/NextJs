...
export const metadata: Metadata = {
    ...
    openGraph: {
        images: [
            {
                url: 'https://insurancesupport.online/api/og?title=Ultimate%20Guide%20to%20Insurance%20Claim%20Recovery%20in%20India&category=Expert%20Guide',
                width: 1200,
                height: 630,
                alt: 'Ultimate Guide to Insurance Claim Recovery in India',
            }
        ],
    },
    alternates: {
                    ...
                    <div className="max-w-4xl mx-auto">
                                ...
                                <div className="grid md:grid-cols-2 gap-12">
                                    <div className="space-y-6">
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-400">A â‚¹50 Lakh death claim was rejected by a private insurer citing &quot;Non-Disclosure of Diabetes&quot; for a 12-year-old policy.</p>
                                            </div>
                                        </div>
                                        <div className="flex gap-4">
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-400">Full claim of â‚¹50 Lakh + â‚¹3.5 Lakh interest settled in 45 days. Nominee secured.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-center">
                                        <div className="text-center p-8 border-2 border-primary/30 rounded-full w-48 h-48 flex flex-col justify-center bg-primary/10">
                                            <span className="text-4xl font-black text-primary">â‚¹53.5L</span>
                        ...
                        <section id="expert" className="text-center bg-slate-50 py-16 px-8 rounded-[40px] border border-slate-100">
                            ...
                            <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
                                ...
                                We operate on a transparency modelâ€”we only take cases where we can genuinely help.
                            </p>
                            ...
                            <ShareButtons title="Ultimate Guide to Insurance Claim Recovery in India" url="https://insurancesupport.online/resources/guides/claim-recovery-guide" />
                        </section>
