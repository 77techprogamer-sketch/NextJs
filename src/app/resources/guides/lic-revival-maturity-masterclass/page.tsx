                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-20">
                                <div className="p-10 bg-white border-2 border-slate-100 rounded-[3rem] shadow-xl relative overflow-hidden group">
                                    ...
                                    <p className="text-slate-500 text-sm italic">Purchase a stamp paper (typically â‚¹100-â‚¹500 depending on state) in the name of the Policyholder.</p>
                                </div>
                                <div className="p-10 bg-white border-2 border-slate-100 rounded-[3rem] shadow-xl relative overflow-hidden group">
