                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        <tr>
                                            ...
                                            <td className="px-8 py-6 text-slate-600">â‚¹1,00,000 (No upper limit)</td>
                                        </tr>
                                        <tr>
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-16">
                                <div className="p-8 bg-green-50 rounded-[3rem] border border-green-100">
                                    ...
                                    <p className="text-green-800/80 text-sm leading-relaxed font-medium">
                                        {"Declared annually per â‚¹1000 of Sum Assured. This is added to your policy every year and is payable either on maturity or death."}
                                        <em> (Recent trend: â‚¹40-50 per â‚¹1000).</em>
                                    </p>
                                </div>
                            ...
                            <ul className="space-y-6 mb-16">
                                ...
                                <li className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-sm italic">{"Premiums paid are eligible for deduction up to â‚¹1.5 Lakhs under Section 80C. This effectively lowers your annual premium cost by 10-30% depending on your tax bracket."}</p>
                                    </div>
                                </li>
                                <li className="flex gap-4 items-start">
                                    <div className="h-10 w-10 rounded-2xl bg-slate-900 text-white flex items-center justify-center shrink-0 shadow-lg">
                            ...
                            <Accordion type="single" collapsible className="w-full">
                                ...
                                <AccordionItem value="faq-2">
                                    ...
                                    <AccordionContent className="text-slate-600 leading-relaxed pb-8 text-lg">
                                        {"It depends on your Age and the Sum Assured. For Sum Assured above â‚¹3 Lakhs and age above 35, a basic medical (SMR) is usually required. Younger applicants with lower SA can often get \"Non-Medical\" approval."}
                                    </AccordionContent>
                                </AccordionItem>
                        ...
                        <div className="bg-slate-50 border-2 border-slate-100 p-12 rounded-[4rem] my-24 relative overflow-hidden group shadow-xl">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link href="/contact" className="px-8 py-4 bg-white rounded-2xl border-2 border-slate-200 text-sm font-black text-slate-900 hover:border-primary hover:text-primary transition-all shadow-sm">Request Bonus Calculation</Link>
                            </div>
                        </div>
