                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-slate-50 p-6 rounded-2xl">
                                    ...
                                    <p className="text-slate-600 mt-2">Occasionally, LIC runs &quot;Revival Campaigns&quot; offering partial interest waivers. We monitor these announcements—contact us to see if a campaign is currently live.</p>
                                </div>
                            </div>
                        </div>
