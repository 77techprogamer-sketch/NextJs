                    ...
                    <article className="flex-1 max-w-4xl">
                        ...
                        <div className="prose prose-slate prose-lg max-w-none">
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        ...
                                        <tr>
                                            ...
                                            <td className="px-8 py-6 text-slate-600">â‚¹1,00,000</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <p className="bg-slate-50 p-8 rounded-3xl text-sm italic border-l-4 border-primary text-slate-500">
                                <strong>Case Study:</strong> For a â‚¹10 Lakh Sum Assured with a 25-year term, assuming a bonus of â‚¹45, the maturity could potentially reach â‚¹23-28 Lakhs depending on the FAB.
                            </p>
