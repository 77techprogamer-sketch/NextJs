                        ...
                        <div className="lg:w-1/2 bg-slate-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-2 gap-8 mb-8">
                                <div>
                                    ...
                                    <div className="text-sm text-slate-400">Claim Settlement Success</div>
                                </div>
                                <div>
                                    <div className="text-4xl font-bold text-primary mb-2">Crores+</div>
            ...
            <section className="py-20 bg-primary/5 border-t border-primary/10">
                <div className="container px-4 mx-auto text-center max-w-4xl">
                    ...
                    <p className="text-xl text-slate-700 mb-10 leading-relaxed">
                        ...
                        or simply want an expert to review your family&apos;s protection planâ€”we are here to support you.
                    </p>
