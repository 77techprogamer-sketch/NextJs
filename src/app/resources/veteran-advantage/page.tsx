...
export const metadata: Metadata = {
    title: 'The Veteran Advantage â€” Why 25+ Years of Insurance Experience Matters | Insurance Support',
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-slate-300 mb-12 leading-relaxed max-w-3xl">
                            Over two decades of battling insurance technicalities, winning rejected claims, and securing families. In the insurance industry, experience is not a luxury â€” it is the difference between a Rs. 0 payout and the full settlement your family deserves.
                        </p>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                            {[
                                { value: '25+', label: 'Years of Active Practice' },
                                { value: '15,000+', label: 'Clients Served' },
                                { value: 'Crores+', label: 'Claims Managed' },
                    ...
                    <div className="flex-1 max-w-4xl">
                        ...
                        <section className="mb-16">
                            ...
                            <div className="prose prose-slate prose-lg max-w-none mb-8">
                                <p>
                                    Because we know how underwriters think, we structure your applications to minimize the risk of future claim rejections. We know exactly which medical documents to submit and how to declare pre-existing conditions safely â€” without triggering unnecessary exclusions or premium loading.
                                </p>
                                <p>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {[
                                    ...
                                    { title: 'Underwriter Rapport', desc: 'We know the underwriting standards of major insurers and present applications in the format they prefer â€” reducing processing time.' },
                                    { title: 'Sum Assured Optimization', desc: 'We calculate the right coverage amount based on your actual income, liabilities, and family structure â€” not a generic formula.' },
                                ].map((item, i) => (
                        ...
                        <section className="mb-16">
                            ...
                            <div className="prose prose-slate prose-lg max-w-none mb-8">
                                <p>
                                    A typical agent stops answering calls when a claim is rejected. A veteran advisor steps in. We draft legal-grade medical representations and fight cases at the grievance and Ombudsman levels â€” a process that requires specialized knowledge of insurance jurisprudence that most agents simply don&apos;t possess.
                                </p>
                                <p>
                        ...
                        <section className="mb-16">
                            ...
                            <div className="space-y-4">
                                {[
                                    { mistake: 'Under-Insurance', desc: 'A â‚¹10 lakh term policy for a family with a â‚¹50 lakh home loan and â‚¹15 lakh annual expenses. The family would face a â‚¹55 lakh shortfall if the worst happened.' },
                                    { mistake: 'Wrong Policy Type', desc: 'A 28-year-old breadwinner sold an endowment plan (â‚¹5 lakh cover) instead of a term plan (â‚¹1 crore cover for the same premium). A tragic misallocation.' },
                                    ...
                                    { mistake: 'No Claim Follow-Through', desc: 'A health claim submitted without pre-hospitalization bills. The insurer deducted 40% of the eligible amount â€” money that could have been recovered with proper documentation.' },
                                ].map((item, i) => (
                            ...
                            <div className="overflow-x-auto border rounded-xl">
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y">
                                        ...
                                        <tr><td className="p-4 border-r font-medium">Rejection Escalation</td><td className="p-4 text-green-700 font-medium">GRO â†’ IRDAI â†’ Ombudsman</td><td className="p-4 text-slate-500">Not available</td></tr>
                        ...
                        <div className="p-8 bg-slate-900 rounded-3xl text-white">
                            ...
                            <p className="text-slate-400 mb-8 leading-relaxed">Whether you need a policy audit, a rejected claim recovered, or simply a trustworthy advisor for your family&apos;s future â€” our 25+ years of hands-on expertise is at your service.</p>
                        ...
                        <div className="sticky top-24 space-y-8">
                            ...
                            <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
                                ...
                                <p className="text-green-800 text-sm leading-relaxed">
                                    From recovering a â‚¹38 lakh death claim rejected on grounds of &quot;non-disclosure&quot; to reviving a 12-year lapsed policy worth â‚¹8 lakhs â€” our results speak volumes. 
                                    <Link href="/success-stories" className="font-bold border-b border-green-600 ml-1 hover:text-green-600 transition-colors">Read case studies â†’</Link>
                                </p>
                            </div>
                        </div>
                    </aside>
