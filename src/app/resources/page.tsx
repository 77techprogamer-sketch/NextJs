            ...
            <section className="py-16">
                <div className="container px-4 mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { title: "Claim Rejection Appeal", desc: "The complete 6-step appeal process for reversing a rejected health insurance claim. Covers GRO, IRDAI, and Ombudsman routes with expected timelines.", href: "/resources/guides/claim-rejection-appeal", icon: Scale },
                            { title: "Term vs Life Insurance", desc: "Side-by-side comparison of premiums, coverage, and returns. When to choose pure protection vs. savings-linked plans for your family's needs.", href: "/resources/guides/term-vs-life-insurance", icon: ShieldCheck },
                            { title: "LIC Maturity Claim", desc: "Step-by-step guide to LIC maturity settlement including Form 3825, NEFT mandate, and how to handle lost policy bonds or name mismatches.", href: "/resources/guides/maturity-claim-guide", icon: FileCheck },
                            { title: "Death Claim Documents", desc: "Complete checklist of forms for LIC and private insurer death claims — Form 3783, 3801, 3785, plus special documents for accidental death cases.", href: "/resources/guides/documents-for-death-claim", icon: ClipboardList },
                            { title: "Cashless Hospitalization", desc: "Planned vs. emergency admission protocols for cashless treatment. How to handle TPA desk submissions, pre-authorization, and denial scenarios.", href: "/resources/guides/cashless-hospitalization-guide", icon: Hospital },
                            { title: "Health Claim Checklist", desc: "Essential document kit for reimbursement claims — discharge summary, bills, payment receipts, and pro tips for minimizing deductions.", href: "/resources/guides/health-insurance-claim-checklist", icon: ClipboardCheck },
                            { title: "LIC Death Claim Guide", desc: "Detailed LIC-specific death claim settlement process with Section 45 incontestability clause, early death investigation timelines, and rejection appeals.", href: "/resources/guides/death-claim-settlement", icon: UserCheck },
                            { title: "Lapsed Policy Revival", desc: "How to restore an old or lapsed LIC policy using Ordinary Revival or Special Revival Schemes (SRS). Includes Form 680 requirements and interest calculations.", href: "/resources/guides/lapsed-policy-revival", icon: RefreshCw }
                        ].map((guide, idx) => (
