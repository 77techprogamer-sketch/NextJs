...
import { BookOpen, FileText, MapPin, Download, Scale, ShieldCheck, FileCheck, ClipboardList, Hospital, ClipboardCheck, UserCheck, RefreshCw, Award, Phone, ArrowRight, CheckCircle2, GraduationCap, Car, Search } from 'lucide-react'
import { Button } from '@/components/ui/button'
import { contactConfig } from '@/data/contact'

export const metadata: Metadata = {
    title: {
        absolute: 'Insurance Resources & Expert Guides â€” Claim Recovery, Policy Management | Insurance Support'
    },
        ...
        <div className="bg-white min-h-screen">
                ...
                <div className="container px-4 mx-auto relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-3xl">
                            Everything you need to know about managing your insurance policies, filing claims, appealing rejections, and protecting your family&apos;s financial future. Written by certified advisors with 25+ years of experience â€” not generic content scraped from the internet.
                        </p>
            ...
            <section className="py-16">
                <div className="container px-4 mx-auto">
                    ...
                    <p className="text-slate-600 mb-8 max-w-2xl">Practical resources for the most common insurance needs â€” from downloading your policy copy to understanding the claim filing process.</p>

                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
                        <Link href="/resources/guides/general-insurance-claim-process" className="group">
                        ...
                        <Link href="/resources/how-it-works" className="group">
                            <Card className="h-full hover:shadow-lg transition-shadow border-slate-200">
                                <CardHeader>
                                    ...
                                    <CardDescription>Our transparent 4-phase process from free consultation to settlement â€” covering strategy, paperwork, escalation, and final payout.</CardDescription>
                                </CardHeader>
                            </Card>
                        </Link>
                        ...
                        <Link href="/resources/veteran-advantage" className="group">
                            <Card className="h-full hover:shadow-lg transition-shadow border-slate-200">
                                <CardHeader>
                                    ...
                                    <CardDescription>Why 25+ years of IRDAI-certified experience matters â€” inside knowledge of underwriting, claims, and the Ombudsman escalation ecosystem.</CardDescription>
                                </CardHeader>
                            </Card>
                        </Link>
                    </div>
                    ...
                    <p className="text-slate-600 mb-8 max-w-2xl">In-depth, step-by-step guides on specific insurance topics â€” from rejected claim appeals to LIC maturity settlements. Each guide includes form numbers, document checklists, and real-world advice.</p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            { title: "Find Lost LIC Policy", desc: "Step-by-step instructions to find your missing LIC policy number and recover lost bonds without paying agent fees.", href: "/resources/guides/lic-revival-maturity-masterclass", icon: Search }
                        ].map((guide, idx) => (
                            <Link key={idx} href={guide.href} className="group">
                                <Card className="h-full hover:shadow-lg transition-shadow border-slate-200">
                                    <CardHeader>
                                        ...
                                        <CardTitle className="group-hover:text-primary transition-colors text-lg">{guide.title} â†’</CardTitle>
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            <div className="flex-1">
                                ...
                                <p className="text-slate-300 text-lg leading-relaxed">
                                    Our resource library covers the most common insurance scenarios. But every case is unique. If your situation isn&apos;t covered here, talk to an expert advisor for personalized guidance â€” completely free.
                                </p>
                            </div>
