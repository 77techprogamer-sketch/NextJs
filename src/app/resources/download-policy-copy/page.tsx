...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'How to Download Insurance Policy Copy Online â€” Complete 2026 Guide',
...
const faqSchema = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'For LIC policies, you need to: (1) publish a public notice in one English and one regional newspaper, (2) submit an Indemnity Bond on non-judicial stamp paper, (3) pay duplicate policy fees at the branch. The duplicate is typically issued in 3-4 weeks. For private insurers, the process is simpler â€” usually a request through the customer portal or a written application is sufficient.'
            }
        },
        {
            '@type': 'Question',
                ...
                <div className="container px-4 mx-auto relative z-10">
                    <div className="max-w-4xl">
                        ...
                        <p className="text-xl text-slate-300 leading-relaxed max-w-3xl">
                            Lost or misplaced your insurance policy document? Don&apos;t worry â€” you can download a copy of your policy online from any major insurer in India within minutes. This guide covers LIC, Star Health, HDFC ERGO, ICICI Prudential, General Insurance, and more.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <div className="flex-1 max-w-4xl">
                        ...
                        <section className="mb-12">
                            ...
                            <Card className="mb-6">
                                ...
                                <CardContent className="space-y-4">
                                    <ol className="list-decimal pl-5 space-y-2 text-slate-600">
                                        <li>Visit <a href="https://licindia.in" target="_blank" rel="nofollow noreferrer" className="text-primary underline font-medium">licindia.in</a> â€” the official LIC website.</li>
                                        <li>Click <strong>&quot;Customer Login&quot;</strong> â†’ select <strong>&quot;Registered User&quot;</strong>.</li>
                            ...
                            <Card className="mb-6">
                                ...
                                <CardContent className="space-y-4">
                                    <ol className="list-decimal pl-5 space-y-2 text-slate-600">
                                        <li>Go to <a href="https://licindia.in" target="_blank" rel="nofollow noreferrer" className="text-primary underline">licindia.in</a> â†’ click <strong>&quot;New User&quot;</strong>.</li>
                        ...
                        <section className="mb-12 pt-8 border-t border-slate-100">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                {[
                                    { insurer: 'Star Health', url: 'https://www.starhealth.in', portal: 'Customer Zone', steps: 'Login â†’ My Policies â†’ Download' },
                                    { insurer: 'HDFC ERGO', url: 'https://www.hdfcergo.com', portal: 'My Account', steps: 'Login â†’ Policy Summary â†’ View & Download' },
                                    { insurer: 'ICICI Lombard', url: 'https://www.icicilombard.com', portal: 'Customer Portal', steps: 'Login â†’ My Policy â†’ Download Schedule' },
                                    { insurer: 'Care Health', url: 'https://www.careinsurance.com', portal: 'Customer Login', steps: 'Login â†’ Dashboard â†’ Policy Download' },
                                ].map((ins, i) => (
                        ...
                        <div className="bg-slate-900 rounded-3xl p-8 text-white">
                            ...
                            <p className="text-slate-400 mb-6 leading-relaxed">
                                If you bought your policy through an advisor, the portal is down, or the process seems complex â€” our team handles the entire document recovery for you. From newspaper ad coordination for LIC duplicate bonds to portal navigation for private insurers.
                            </p>
                        ...
                        <div className="sticky top-24 space-y-6">
                            ...
                            <div className="p-6 bg-green-50 rounded-xl border border-green-100">
                                ...
                                <ul className="space-y-2">
                                    {[
                                        { label: 'Lost LIC Policy Recovery Help', href: '/resources/guides/lic-revival-maturity-masterclass' },
                                        ...
                                        <li key={i}>
                                            <Link href={link.href} className="text-sm text-green-700 hover:text-green-900 font-medium hover:underline">{link.label} â†’</Link>
                                        </li>
                                    ))}
                                </ul>
                            </div>
