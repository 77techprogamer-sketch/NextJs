...
export const metadata: Metadata = {
  title: "Insurance Services in Saharanspur",
  description: "Expert insurance services in Saharanspur. LIC policy support, health insurance, motor insurance, claim assistance & policy revival. Free consultation.",
  keywords: ["insurance services Saharanspur", "LIC agent Saharanspur", "health insurance Saharanspur", "motor insurance Saharanspur", "insurance claim support Saharanspur", "LIC policy revival Saharanspur"],
};
...
const areas = [
  "Saharanspur Central", "Saharanspur East", "Saharanspur West", "Saharanspur North", "Saharanspur South",
  "Sector 1", "Sector 2", "Sector 3", "Main Road", "Station Road",
  "Market Area", "Industrial Area", "Residential Zone", "Commercial Hub", "IT Park"
];

const faqs = [
  { qKey: "faq_find_agent_q", a: "Look for an IRDAI-registered advisor with experience in LIC products. Our team has 25+ years of experience serving Saharanspur residents. Call +91-9986634506 for a free consultation." },
  { qKey: "faq_revive_lapsed_q", a: "Yes! We help revive lapsed LIC policies across Saharanspur. Most policies can be revived within 5 years of the first unpaid premium. We handle the entire process for you." },
  { qKey: "faq_doorstep_q", a: "Yes. We provide free doorstep consultation across all Saharanspur areas. Our advisor will visit your home or office at a convenient time -- including evenings and weekends." },
