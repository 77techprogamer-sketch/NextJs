...
export const metadata: Metadata = {
  title: "Insurance Services in Jamshedpur",
  description: "Expert insurance services in Jamshedpur. LIC policy support, health insurance, motor insurance, claim assistance & policy revival. Free consultation.",
...
const areas = [
  "Jamshedpur Central", "Jamshedpur East", "Jamshedpur West", "Jamshedpur North", "Jamshedpur South",
  "Sector 1", "Sector 2", "Sector 3", "Main Road", "Station Road",
  "Market Area", "Industrial Area", "Residential Zone", "Commercial Hub", "IT Park"
];

const faqs = [
  { qKey: "faq_find_agent_q", a: "Look for an IRDAI-registered advisor with experience in LIC products. Our team has 25+ years of experience serving Jamshedpur residents. Call +91-9986634506 for a free consultation." },
  { qKey: "faq_revive_lapsed_q", a: "Yes! We help revive lapsed LIC policies across Jamshedpur. Most policies can be revived within 5 years of the first unpaid premium. We handle the entire process for you." },
  { qKey: "faq_doorstep_q", a: "Yes. We provide free doorstep consultation across all Jamshedpur areas. Our advisor will visit your home or office at a convenient time -- including evenings and weekends." },
      ...
      <section className="bg-slate-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="https://wa.me/919986634506?text=Hi%20Insurance%20Support%2C%20I%20need%20insurance%20help%20in%20Jamshedpur" className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-xl font-bold text-lg transition-colors flex items-center gap-2"><MessageCircle className="w-5 h-5" />{t("whatsapp_us", "WhatsApp Us")}</a>
          </div>
        </div>
      </section>
