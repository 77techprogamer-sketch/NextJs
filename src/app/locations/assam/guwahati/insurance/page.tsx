...
export const metadata: Metadata = {
  title: "Insurance Services in Guwahati 2026 | LIC, Health, Motor | Insurance Support",
  description: "Expert insurance services in Guwahati. LIC policy support, health insurance, motor insurance, claim assistance, and policy revival. Free consultation. Call +91-9986634506.",
  keywords: ["insurance services Guwahati", "LIC agent Guwahati", "health insurance Guwahati", "motor insurance Guwahati", "insurance claim support Guwahati", "LIC policy revival Guwahati"],
};

const services = [
  { title: "LIC Policy Support", desc: "Complete LIC policy assistance in Guwahati -- new policy purchase, premium payment, policy status check, revival of lapsed policies, and maturity claim support.", features: ["New LIC policy guidance", "Premium payment assistance", "Policy status check", "Lapsed policy revival", "Maturity claim support", "Loan against policy"] },
  { title: "Health Insurance", desc: "Find the best health insurance plans in Guwahati. Compare policies from all major insurers, get cashless hospitalization support at Manipal, Apollo, Fortis, Narayana Health, and claim assistance.", features: ["Policy comparison", "Cashless claim support", "Reimbursement claims", "Family floater plans", "Senior citizen plans", "Section 80D tax benefits"] },
  { title: "Motor Insurance", desc: "Car and bike insurance in Guwahati. Compare quotes, renew online, maximize No Claim Bonus, and get claim support for accidents and theft.", features: ["Online renewal", "NCB optimization", "Zero depreciation cover", "Engine protection", "Claim assistance", "Multi-insurer comparison"] },
  { title: "Claim Assistance", desc: "Stuck with a rejected insurance claim in Guwahati? Our experts help you fight back -- from internal grievance to Insurance Ombudsman to consumer court.", features: ["Claim rejection appeal", "GRO complaint filing", "Ombudsman support", "Documentation help", "Follow-up with insurer", "Legal guidance"] },
  { title: "Term Insurance Planning", desc: "Get the right term insurance coverage for your family in Guwahati. Compare plans from all insurers, calculate the right coverage amount, and buy online.", features: ["Coverage calculation", "Plan comparison", "Online purchase support", "Rider selection", "Medical test coordination", "Policy delivery"] },
  { title: "Policy Revival & Recovery", desc: "Has your LIC or insurance policy lapsed? We help revive policies in Guwahati -- even those lapsed for years. Recover your investment and restore life cover.", features: ["LIC policy revival", "Special revival schemes", "Paid-up value recovery", "Surrender value calculation", "Unclaimed amount recovery", "Lost policy bond retrieval"] },
];
...
const bangaloreTestimonials = [
  ...
  { name: "Suresh M", area: "JP Nagar", text: "Best LIC agent in Guwahati. Helped me compare and choose the right policy for my family. Very knowledgeable.", rating: 5 },
];
    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <section className="bg-slate-900 text-white py-16 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">Expert Insurance Services in Guwahati</h1>
          <p className="text-xl text-slate-300 mb-4 max-w-2xl">LIC policy support, health insurance, motor insurance, claim assistance & policy revival. Serving all areas of Guwahati with 25+ years of experience.</p>
      ...
      <section className="py-16 px-4 bg-emerald-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-6 text-center">Why Why Guwahati Trusts Insurance Support</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-emerald-100">
              ...
              <p className="text-sm text-slate-600">Our advisors know every area of Guwahati -- across all major areas. We understand local healthcare costs, insurance needs of residents, and Guwahati-specific claim processes.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-emerald-100">
              ...
              <p className="text-sm text-slate-600">We ensure your health insurance works at GNRC Hospitals, Apollo Hospital, Hayat Hospital, Nemcare Hospital, and 400+ network hospitals across Guwahati.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-emerald-100">
              ...
              <p className="text-sm text-slate-600">We come to your home or office anywhere in Guwahati. No need to travel. Free consultation at your convenience -- evenings and weekends available.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-4">Our Services in Guwahati</h2>
          <p className="text-slate-600 text-center mb-12 max-w-2xl mx-auto">Comprehensive insurance support for individuals, families, and businesses across Guwahati.</p>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold text-center mb-4">What Guwahati Customers Say</h2>
          <p className="text-slate-600 text-center mb-10">Real feedback from families and professionals across Guwahati.</p>
          <div className="grid md:grid-cols-3 gap-6">
              ...
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border border-slate-100">
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-slate-100">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 flex items-center gap-1"><MapPin className="w-3 h-3" />{t.area}, Guwahati</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-4">Areas We Serve in Guwahati</h2>
          <p className="text-slate-600 text-center mb-12">Doorstep insurance assistance across all major neighborhoods of Guwahati.</p>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {["Guwahati City", "Guwahati East", "Guwahati West", "Guwahati North", "Guwahati South", "Main Road", "Station Road", "Market Area"].map((area, idx) => (
      ...
      <section className="py-20 px-4 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-center mb-12">Frequently Asked Questions — Guwahati</h2>
          <div className="space-y-4">
            <div className="bg-white rounded-xl border border-slate-200 p-6"><h3 className="font-bold text-lg mb-2">How do I find a reliable LIC agent in Guwahati?</h3><p className="text-slate-600">Look for an IRDAI-registered advisor with deep LIC product knowledge. Our Guwahati team has 25+ years of experience. Call +91-99866 34506 for a free, no-obligation consultation.</p></div>
            <div className="bg-white rounded-xl border border-slate-200 p-6"><h3 className="font-bold text-lg mb-2">Can you help revive my lapsed LIC policy in Guwahati?</h3><p className="text-slate-600">Yes. We revive lapsed LIC policies across Guwahati -- even those lapsed for years. Most policies can be revived within 5 years of the first unpaid premium. We handle all paperwork and follow-up.</p></div>
            <div className="bg-white rounded-xl border border-slate-200 p-6"><h3 className="font-bold text-lg mb-2">Do you provide doorstep service in Guwahati?</h3><p className="text-slate-600">Yes. We provide free doorstep consultation across all Guwahati areas. Our advisor will visit your home or office at a convenient time -- including evenings and weekends.</p></div>
      ...
      <section className="py-20 px-4 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Get Expert Insurance Help in Guwahati</h2>
