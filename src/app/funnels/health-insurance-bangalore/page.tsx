...
const localBusinessSchema = {
    ...
    name: 'Insurance Support â€” Health Insurance Bangalore',
...
const faqSchema = {
    ...
    mainEntity: [
        ...
        },
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'Given Bangalore\'s healthcare costs, we recommend a minimum of â‚¹10 lakhs coverage for an individual and â‚¹15-25 lakhs for a family floater. A single hospitalization at a private hospital like Manipal or Apollo can easily cost â‚¹3-8 lakhs. For IT professionals with families, â‚¹25-50 lakhs is recommended to supplement employer-provided group cover.'
            }
        },
        {
            '@type': 'Question',
        ...
        <div className="min-h-screen bg-white dark:bg-slate-950">
            ...
            <section className="py-20 bg-slate-50">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="prose prose-slate prose-lg max-w-none mb-10">
                        <p>
                            Bangalore is home to India&apos;s most advanced private healthcare ecosystem â€” with world-class hospitals like <strong>Manipal Hospital, Apollo Hospitals, Narayana Health, Fortis, Columbia Asia, and Aster CMI</strong>. While this means excellent medical care, it also means significantly higher treatment costs compared to other Indian cities.
                        </p>
                        <p>
                            A single hospitalization for cardiac surgery at Narayana Health can cost â‚¹5-12 lakhs. A knee replacement at Manipal Hospital averages â‚¹3.5-6 lakhs. Without the right health insurance plan with adequate coverage and cashless access at your preferred hospital, these expenses can devastate a family&apos;s savings.
                        </p>
                        <p>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            { name: 'Star Family Health Optima', cover: 'â‚¹5L â€“ â‚¹1Cr', best: 'Best for Families', highlights: ['400+ Bangalore hospitals', 'Automatic restoration', 'No room rent sublimit'] },
                            { name: 'HDFC ERGO Optima Secure', cover: 'â‚¹3L â€“ â‚¹50L', best: 'Best Value for IT Professionals', highlights: ['Cashless at all major chains', '100% no claim bonus', 'Maternity cover option'] },
                            { name: 'Care Health Platinum', cover: 'â‚¹5L â€“ â‚¹6Cr', best: 'Best Comprehensive Cover', highlights: ['Unlimited restore benefit', 'AYUSH treatment cover', 'Global cover option'] },
                            { name: 'Niva Bupa ReAssure 2.0', cover: 'â‚¹5L â€“ â‚¹3Cr', best: 'Best for Senior Citizens', highlights: ['No medical test up to 55', 'Consumables covered', 'Air ambulance cover'] },
                            { name: 'Star Senior Citizens', cover: 'â‚¹1L â€“ â‚¹25L', best: 'Most Affordable for Seniors', highlights: ['Entry age up to 75', 'Pre-existing cover from day 1', 'Domiciliary treatment'] },
                            { name: 'ICICI Lombard iHealth', cover: 'â‚¹2.5L â€“ â‚¹1Cr', best: 'Best for Young Professionals', highlights: ['Cashless Everywhere feature', 'Wellness discount program', 'Mental health cover'] },
                        ].map((plan, i) => (
                    ...
                    <p className="text-sm text-slate-500 mt-6 text-center">
                        Premiums and benefits vary by age and coverage. <Link href="/contact" className="text-primary font-bold hover:underline">Get a personalized quote â†’</Link>
                    </p>
                </div>
            </section>
            ...
            <section className="py-16 bg-slate-50">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h2 className="text-3xl font-bold text-slate-900 mb-8">Health Insurance FAQs â€” Bangalore Specific</h2>
                    <div className="space-y-4">
                        {[
                            ...
                            { q: 'What minimum health coverage is recommended in Bangalore?', a: 'We recommend â‚¹10 lakhs minimum for individuals and â‚¹15-25 lakhs for family floaters. A single hospitalization at Manipal or Apollo can cost â‚¹3-8 lakhs. IT professionals should get â‚¹25-50 lakhs to supplement employer group cover.' },
                            { q: 'Can I get doorstep health insurance service in Bangalore?', a: 'Yes â€” our local advisors provide free doorstep service across all Bangalore areas including Indiranagar, Koramangala, Whitefield, HSR Layout, Electronic City, and more. We handle plan comparison, proposal filling, and claim support at your home or office.' },
                        ].map((faq, i) => (
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row items-center gap-10">
                            <div className="flex-1">
                                ...
                                <p className="text-blue-100 text-lg leading-relaxed">
                                    Don&apos;t guess which plan is right. Our local advisors compare all top plans, check your preferred hospital&apos;s cashless availability, and ensure your family is fully protected â€” all for free.
                                </p>
                            </div>
