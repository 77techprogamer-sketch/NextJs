            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-5xl">
                    ...
                    <div className="prose prose-slate prose-lg max-w-none mb-10">
                        ...
                        <p>
                            Our team has successfully revived thousands of policies for clients across India, recovering an estimated <strong>â‚¹crores</strong> in policy value that was otherwise frozen. Whether your policy lapsed 2 years ago or 12 years ago, there is likely a revival path available.
                        </p>
                    </div>
                </div>
            </section>
