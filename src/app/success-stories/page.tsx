...
export const metadata: Metadata = {
    title: 'Insurance Claim Success Stories | Proof of Expert Recovery â€” â‚¹50Cr+ Recovered',
    description: 'Read how we recovered â‚¹50Cr+ in rejected insurance claims. Real case studies on LIC policy revival, health claim appeals, motor insurance settlements, and death claim recoveries across India.',
    keywords: [
                ...
                <div className="container px-4 mx-auto relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                            Numbers don&apos;t lie. Our 25+ years of experience has helped thousands of families recover what was rightfully theirs. Every case study below represents a real family that received their money â€” often after being told by others that their case was hopeless.
                        </p>
            ...
            <section className="py-16 bg-white">
                <div className="container px-4 mx-auto max-w-4xl">
                    ...
                    <p className="text-slate-600 mb-10 leading-relaxed">
                        Every successful recovery follows our battle-tested methodology. We don&apos;t rely on luck or sympathy â€” we build a strong, evidence-backed case that insurance companies and regulatory bodies cannot ignore.
                    </p>
                    <div className="space-y-6">
                        {[
                            ...
                            { step: '3', title: 'Legal-Grade Representation', desc: 'Our appeal documents are structured to the standards expected by the Insurance Ombudsman â€” the Annexure VI-A format with clear factual chronology, medical evidence, and legal precedent references.' },
            ...
            <section className="py-16 bg-slate-50 border-t border-slate-100">
                <div className="container px-4 mx-auto max-w-5xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { quote: 'After my father passed, LIC rejected our death claim citing non-disclosure. Insurance Support took over, filed at the Ombudsman, and we received the full â‚¹25 lakhs within 4 months.', name: 'Priya M.', location: 'Bangalore' },
                            ...
                            { quote: 'I had a lapsed LIC policy from 2008 that I thought was worthless. They found a Special Revival Scheme window, revived it, and I received â‚¹8.5 lakhs in bonuses I didn\'t know existed.', name: 'Sunita B.', location: 'Mumbai' },
                        ].map((testimonial, idx) => (
                            <div key={idx} className="p-6 bg-white rounded-2xl border border-slate-100 shadow-sm">
