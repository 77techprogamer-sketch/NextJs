...
export default function CaseStudyPage() {
  ...
  const service = 'Lost Policy Bond Recovery';
  const rating = 5;
  const timeline = '2 Weeks';
  const story = `Priya Menon from Chennai had lost her LIC policy bond during a house move. "I had been paying premiums for 15 years but couldn't locate the original policy document," she explains. "LIC told me I needed the policy bond to make any claim." Insurance Support helped Priya file for a duplicate policy through LIC's procedure, tracking down the policy number using her PAN and personal details. Within 2 weeks, the duplicate was issued. "I never thought this was possible without the original. They truly deliver what they promise."`;
    ...
    <section className='py-16 md:py-20 bg-white'>
      <div className='container mx-auto px-4 max-w-3xl'>
        ...
        <h1 className='text-3xl md:text-4xl font-bold text-slate-900 mb-4'>
          Lost LIC Policy Bond Found & Recovered - Priya Menon
        </h1>
