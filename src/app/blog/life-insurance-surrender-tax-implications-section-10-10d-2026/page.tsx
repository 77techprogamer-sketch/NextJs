...
export default async function BlogPostPage({ params }: BlogPostProps) {
    ...
    const ctaStr = '**Need expert assistance?** Explore our [' + serviceLink.label + '](' + serviceLink.url + ') for professional guidance, policy management, and claim support.';
