...
export const metadata: Metadata = {
    ...
    description: 'Meet Hari Kotian â€” top-rated LIC advisor on Justdial (4.2â˜…), IRDAI-certified with 25+ years of experience. Serving Jalahalli, Bahubali Nagar & all of Bangalore. Specializing in claim recovery, lapsed policy revival, and health insurance disputes.',
                            ...
                            <div className="prose prose-slate prose-lg max-w-none">
                                ...
                                <div className="grid sm:grid-cols-2 gap-6 not-prose">
                                    {[
                                        ...
                                        { title: "Crores in Claims Managed", desc: "Expertly handled death claims, critical illness settlements, and major motor recovery cases.", color: "text-green-600" },
                                        ...
                                        { title: "Thousands of Families Served", desc: "A trusted local expert for over two decades, helping Bangalore families navigate complex insurance situations.", color: "text-green-600" }
                                    ].map((item, i) => (
