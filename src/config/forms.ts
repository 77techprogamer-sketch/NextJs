...
export const QUALIFICATION_FIELDS: FormFieldConfig[] = [
    {
        name: 'portfolioStatus',
        labelKey: 'portfolio_status',
        type: 'radio',
        options: [
            { labelKey: 'starting_from_scratch', value: 'Scratch' },
            { labelKey: 'existing_portfolio', value: 'Existing' }
        ]
    },
    {
        name: 'primaryGoal',
        ...
        type: 'radio',
        options: [
            { labelKey: 'protecting_family', value: 'Protection' },
            { labelKey: 'tax_planning', value: 'Tax/Wealth' }
        ]
    },
    {
        name: 'urgency',
        labelKey: 'urgency_to_finalize',
        type: 'radio',
        options: [
            { labelKey: 'finalize_this_month', value: 'This Month' },
            { labelKey: 'researching_options', value: 'Researching' }
        ]
    }
];
