...
export const CITY_CONTENT_OVERRIDES: Record<string, CityOverride> = {
    ...
    bangalore: {
        summary: "Expert guidance for health and life insurance in Bangalore's Silicon Valley. Specialized support for IT professionals (Manyata, Electronic City) and doorstep document coordination for senior citizens in Jayanagar and Indiranagar.",
        facts: [
            ...
            "Physical proximity to LIC Residency Road & J.C. Road branches."
        ],
        localContext: "Based out of Jalahalli, our core team has served over 15,000 clients across Bangalore. Medical inflation here is at 15%, making personal health covers a necessity over corporate GHI.",
        serviceSpecific: {
            'health-insurance': {
