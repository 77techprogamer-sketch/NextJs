    ...
    useEffect(() => {
        const fetchLocation = async () => {
            ...
            try {
                ...
                // Only allow Indian cities to be shown dynamically to maintain brand focus
                const city = country_code === 'IN' ? (data.city || 'Bangalore') : null;
                ...
                try {
                    ...
                    setLocation({
                        city: null, // Fallback to India generic
                        region: null,
                        country_code: 'IN',
                        loading: false,
