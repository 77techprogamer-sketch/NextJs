      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center sm:text-left">
            <h4 className="font-bold text-foreground mb-4 uppercase tracking-wider text-xs">{t("footer_headquarters", "Headquarters")}</h4>
            <p className="text-sm mb-2">{t("bangalore_office")}</p>
            <p className="text-xs font-medium uppercase tracking-tighter opacity-70">{t("footer_established", "Established 1998")}</p>
          </div>
        </div>
