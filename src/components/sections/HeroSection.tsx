...
const HeroSection: React.FC<HeroSectionProps> = ({ city, onGetQuote, title: propTitle, description: propDescription }) => {
    ...
    return (
        <LazyMotion features={domAnimation}>
            <section id="hero" className="relative w-full h-auto pb-16 pt-8 flex flex-col overflow-hidden bg-primary text-white">
                {/* Background Effects */}
                ...
                <div className="relative z-10 w-full container mx-auto px-4 flex flex-col items-center text-center space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mt-8 pt-4 animate-fade-up [animation-delay:800ms]">
                        <ScrollReveal animation="pop-up" delay={1.2}>
                            <div className="flex flex-col items-center gap-2 group hover:-translate-y-2 transition-transform duration-300">
                                <span className="text-3xl font-bold text-white group-hover:text-accent transition-colors">25+</span>
                                <span className="text-sm text-gray-400 uppercase tracking-wider font-medium" suppressHydrationWarning>Years of Expertise</span>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal animation="pop-up" delay={1.3}>
                            <div className="flex flex-col items-center gap-2 group hover:-translate-y-2 transition-transform duration-300">
                                <span className="text-3xl font-bold text-white group-hover:text-accent transition-colors">1000+</span>
                                <span className="text-sm text-gray-400 uppercase tracking-wider font-medium" suppressHydrationWarning>Claims Resolved</span>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal animation="pop-up" delay={1.4}>
                            <div className="flex flex-col items-center gap-2 group hover:-translate-y-2 transition-transform duration-300">
                                <span className="text-3xl font-bold text-white group-hover:text-accent transition-colors">IRDAI</span>
                                <span className="text-sm text-gray-400 uppercase tracking-wider font-medium" suppressHydrationWarning>Registered</span>
                            </div>
                        </ScrollReveal>
                        <ScrollReveal animation="pop-up" delay={1.5}>
                            <div className="flex flex-col items-center gap-2 group hover:-translate-y-2 transition-transform duration-300">
                                <span className="text-3xl font-bold text-white group-hover:text-accent transition-colors">Pan-India</span>
                                <span className="text-sm text-gray-400 uppercase tracking-wider font-medium" suppressHydrationWarning>Service</span>
                            </div>
                        </ScrollReveal>
                    </div>
                </div>
