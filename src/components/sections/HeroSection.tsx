...
const HeroSection: React.FC<HeroSectionProps> = ({ city, onGetQuote, title: propTitle, description: propDescription }) => {
    ...
    const dynamicOneLiner = propDescription || t("hero_fallback_description");
                                    ...
                                    <MagneticButton>
                                        ...
                                        >
                                            <span suppressHydrationWarning className="flex items-center gap-2">
                                                {t("cta_buy_policy", { defaultValue: "Request Case Assessment" })}
                                                <motion.div
                                                    animate={{ x: [0, 5, 0] }}
                                    ...
                                    <MagneticButton>
                                        ...
                                        >
                                            <span suppressHydrationWarning className="flex items-center gap-2">
                                                ...
                                                {t("cta_claim_support", { defaultValue: "Recover Rejected Claim" })}
                                            </span>
                                        </Button>
                                    </MagneticButton>
                                </ScrollReveal>
