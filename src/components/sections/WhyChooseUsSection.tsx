...
const WhyChooseUsSection = ({ title, expertGuidance, expertGuidanceDesc, supportTitle, supportDesc, claimsTitle, claimsDesc }: WhyChooseUsProps) => {
        return (
            ...
            <div className="container mx-auto px-4 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <SpotlightCard className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-8 text-center hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4" suppressHydrationWarning>{expertGuidance}</h3>
                    ...
                    <SpotlightCard className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-8 text-center hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4" suppressHydrationWarning>{supportTitle}</h3>
                        <p className="text-gray-600 dark:text-gray-300" suppressHydrationWarning>
                            {supportDesc}
                        </p>
                    </SpotlightCard>
                    ...
                    <SpotlightCard className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-8 text-center hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4" suppressHydrationWarning>{claimsTitle}</h3>
                        <p className="text-gray-600 dark:text-gray-300" suppressHydrationWarning>
                            {claimsDesc}
                        </p>
                    </SpotlightCard>
