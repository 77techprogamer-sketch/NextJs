...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
    ...
    return (
        <div className="flex items-center gap-3 py-6 border-y border-border/50 my-8">
            ...
            <Button variant="outline" size="icon" className="rounded-full hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-colors" asChild>
            ...
            <Button variant="outline" size="icon" className="rounded-full hover:bg-blue-400 hover:text-white hover:border-blue-400 transition-colors" asChild>
                <a href={shareLinks.twitter} target="_blank" rel="noopener noreferrer" aria-label="Share on X (Twitter)">
                    <Twitter className="w-4 h-4 fill-current" />
                </a>
            </Button>
            <Button variant="outline" size="icon" className="rounded-full hover:bg-blue-700 hover:text-white hover:border-blue-700 transition-colors" asChild>
