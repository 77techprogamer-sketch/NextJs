...
const LanguageSwitcher = () => {
  ...
  const changeLanguage = async (lng: string) => {
    ...
    try {
      // Change language in i18next (instant for client components)
      await i18n.changeLanguage(lng);
      setSelectedLanguage(lng);
      
      // Set cookies for SSR detection
      ...
      // Reload to update SSR-rendered content from server
      // Client components will already show new language instantly
