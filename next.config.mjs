    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'origin-when-cross-origin' },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.clarity.ms https://*.clarity.ms https://www.googletagmanager.com https://static.cloudflareinsights.com ; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data: https://*.clarity.ms https://c.bing.com https://idzvdeemgxhwlkyphnel.supabase.co https://i.pravatar.cc https://*.pravatar.cc https://www.googletagmanager.com; font-src 'self' data:; frame-src 'self' https://udify.app; connect-src 'self' https://*.clarity.ms https://c.bing.com https://idzvdeemgxhwlkyphnel.supabase.co wss://idzvdeemgxhwlkyphnel.supabase.co https://api.ipify.org https://www.google-analytics.com https://*.google-analytics.com https://stats.g.doubleclick.net https://*.cloudflareinsights.com https://*.cloudflareinsights.com; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none'; upgrade-insecure-requests; "
          },
          {
